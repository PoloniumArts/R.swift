Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                   ...
                   * Compile time checks and errors instead of runtime crashes
                   DESC
  spec.homepage     = "https://github.com/PoloniumArts/R.swift"
  spec.documentation_url = "https://github.com/PoloniumArts/R.swift/tree/master/Documentation"
  spec.screenshots  = [ "https://raw.githubusercontent.com/PoloniumArts/R.swift/master/Documentation/Images/DemoUseImage.gif",
                        "https://raw.githubusercontent.com/PoloniumArts/R.swift/master/Documentation/Images/DemoRenameImage.gif" ]

  spec.author             = { "Mathijs Kadijk" => "mkadijk@gmail.com" }
  spec.social_media_url   = "https://twitter.com/mac_cain13"

  spec.requires_arc = true
  spec.source = { :http => "https://github.com/PoloniumArts/R.swift/releases/download/v#{spec.version}/rswift-#{spec.version}.zip" }
